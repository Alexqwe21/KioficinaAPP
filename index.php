...
<body>
    <main>
        ...
        <section class="login container">
            <div class="logo">
                <img src="<?php echo BASE_URL;?>public/assets/img/logoKiOficina.svg" alt="Logotipo KiOficina">
            </div>

            <h2 class="titulo">Login</h2>

            <form method="" action="<?php echo BASE_URL ?>/app/views/home.php" class="form_box container">
